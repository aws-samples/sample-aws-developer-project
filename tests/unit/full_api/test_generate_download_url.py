...
@moto.mock_aws
class TestGenerateDownloadUrl(unittest.TestCase):
   
   def setUp(self):
      import aws_developer_sample_project.module6.generate_download_url as the_lambda
   ...
   def test_get_url(self):
      ...
      self.assertEqual(body['download_url'].split('?')[0], 'https://mybucket.s3.amazonaws.com/products/1/main.jpg') 
